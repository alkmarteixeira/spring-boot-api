(function () {
    ...
    function routeConfig($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('dashboard.pessoaFisica', {
                url: "/pessoa-fisica",
                views: {
                    "dashboard": {
                        templateUrl: 'views/pessoa-fisica/PessoaFisica.html',
                    },
                },
                ncyBreadcrumb: {
            ...
            .state('dashboard.pessoaJuridica', {
                url: "/pessoa-juridica",
                views: {
                    "dashboard": {
                        templateUrl: 'views/pessoa-juridica/PessoaJuridica.html',
                    },
                },
                ncyBreadcrumb: {
